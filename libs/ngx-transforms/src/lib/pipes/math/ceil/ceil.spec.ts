...
describe('CeilPipe', () => {
  ...
  it('should ceil integer as itself', () => {
  ...
  it('should ceil to 1 decimal place', () => {
    expect(pipe.transform(4.11, 1)).toBe(4.2);
  });

  it('should ceil small fractions up', () => {
    expect(pipe.transform(0.001, 2)).toBe(0.01);
  });
  ...
  it('should handle negative numbers (toward zero)', () => {
  ...
  it('should handle large precision', () => {
    expect(pipe.transform(0.123456789, 6)).toBe(0.123457);
  });
  ...
  it('should ceil exact decimal values unchanged', () => {
    expect(pipe.transform(4.5, 1)).toBe(4.5);
  });

  it('should ceil precision 0 explicitly', () => {
    expect(pipe.transform(4.01, 0)).toBe(5);
  });

  it('should handle precision 3', () => {
    expect(pipe.transform(1.2341, 3)).toBe(1.235);
  });
});